    ...
    <>
      ...
      <ProductContainer>
        ...
        <ProductDetails>
          ...
          <button disabled={isItemAlreadyInCart} onClick={handleBuyProduct}>{isItemAlreadyInCart ? "Item já adicionado" : "Colocar na sacola"}</button>
